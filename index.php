                            ...
                            <div class="form-bottom">
                                <form role="form" action="entrar.php" method="post" class="login-form">
                                    <div class="form-group">
                                        <input required type="text" name="user" placeholder="Nombre de usuario..." class="form-username form-control" id="form-username">
                                    </div>
                                    <div class="form-group">
                                        <input required type="password" name="pass" placeholder="Contraseña" class="form-password form-control" id="form-password">
                                    </div>
                                    <?php echo $toquen; ?>
